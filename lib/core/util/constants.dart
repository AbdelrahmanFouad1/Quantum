...
const Color secondaryVariant1 = Color.fromRGBO(33, 36, 36, 0.7);
    ...
    if (value != null) {
      if (productModel.stock > 0) {
        ...
        CartModel cartModel = CartModel(
          ...
          quantity: AppCubit.get(context).itemCount,
        );
        ...
        sl<CacheHelper>()
          ...
          model.toJson(),
            ...
            .then((value) {
          AppCubit.get(context).addToCartMap(cartModel);
...
void removeFromCart({
  ...
  sl<CacheHelper>().get('cart').then((value) {
    if (value != null) {
      ...
      model.data.removeWhere((element) => element.pId == id);
      ...
      sl<CacheHelper>()
        ...
        model.toJson(),
          ...
          .then((value) {
        AppCubit.get(context).removeFromCartMap(id);

        debugPrint('cart removed !!!');
      });
    }
  });
}
